DEVELOPER: Replace occurrences of HeidiSQLPortable in this file with the
...
user in an INI file next to HeidiSQLPortable.exe called HeidiSQLPortable.ini.
...
copy AppNamePortable.ini from this directory to HeidiSQLPortable.ini next to
HeidiSQLPortable.exe. The options in the INI file are as follows:
